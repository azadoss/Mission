          ...
          <CardContent className="p-6 space-y-4">
            ...
            {!isSharing ? (
              <Button 
                ...
                className={`w-full ${!isConnected ? "border-red-300 text-red-700" : ""}`}
              >
            ...
            <ScrollArea className="h-[400px] pr-4">
              <div className="space-y-4">
                {messages.map((message, index) => (
                  ...
                  >
                    <div className={`h-8 w-8 rounded-full flex items-center justify-center ${message.sender === "Gemini" ? "bg-primary" : "bg-secondary"}`}>
